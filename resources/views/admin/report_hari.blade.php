            ...
            <div class="w-full mb-6">
                <div class="flex space-x-7 mb-7">
                    <div class="text-fill bg-primary w-1/2 h-40 rounded-xl px-8 py-6">
                        ...
                        @if($dataDetail != [])<h1 class="font-bold mt-6 text-5xl">{{ $banyakMenu }}</h1>@else<h1 class="text-fill font-bold text-2xl">Tidak ada Pemesanan</h1>@endif
                    </div>
                    <div class="text-fill bg-primary w-1/2 h-40 rounded-xl px-8 py-6">
                        <p>Jumlah Menu Yang Terjual</p>
                        @if($dataDetail != [])<h1 class="font-bold mt-6 text-5xl">{{ $jumlahMenu}}</h1>@else<h1 class="text-fill font-bold text-2xl">Tidak ada Pemesanan</h1>@endif
                    </div>
                </div>
